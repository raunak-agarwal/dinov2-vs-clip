# Original script: https://github.com/MIT-LCP/mimic-cxr/blob/master/txt/create_section_files.py
...
# Usage: python extract_mimic.py --reports_path /data/mimic-cxr/reports/files --output_path /data/mimic-cxr/
import sys
import os
import argparse
import csv
...
# local folder import
import mimic_section_parser as sp
