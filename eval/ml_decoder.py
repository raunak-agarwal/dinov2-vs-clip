# Adds a ML-Decoder head to a ViT model. 
# Taken from https://github.com/Alibaba-MIIL/ML_Decoder/blob/main/src_files/ml_decoder/ml_decoder.py
...
class MLDecoder(nn.Module):
    def __init__(self, num_classes, num_of_groups=-1, decoder_embedding=768,
        ...
        layer_decode = nn.TransformerDecoderLayer(nhead=8, d_model=decoder_embedding, 
